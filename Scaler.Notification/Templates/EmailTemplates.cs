namespace Scaler.Notification.Templates
{
    public static class EmailTemplates
    {
        ...
        {
            testEmailTemplate ??= ReadPhysicalFile("Templates/TestEmail.template");
        ...
        {
            plainTextTestEmailTemplate ??= ReadPhysicalFile("Templates/PlainTextTestEmail.template");
