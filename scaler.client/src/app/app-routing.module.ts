...
const routes: Routes = [
  ...
  { path: 'user-preferences', component: UserPreferencesComponent, canActivate: [AuthGuard], title: 'UserPreferences' },
  { path: 'users-management', component: UsersManagementComponent, canActivate: [AuthGuard], title: 'UsersManagement' },
  { path: 'roles-management', component: RolesManagementComponent, canActivate: [AuthGuard], title: 'RolesManagement' },
  ...
  { path: 'userInfo', component: UserInfoComponent, canActivate: [AuthGuard], title: 'userInfo' },
