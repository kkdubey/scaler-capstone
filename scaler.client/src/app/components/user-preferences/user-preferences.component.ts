...
export class UserPreferencesComponent {
  ...
  setAsDefault() {
    this.alertService.showDialog('Are you sure you want to set the configuration as your new defaults?', DialogType.confirm,
      ...
      .subscribe({
        ...
        error: error => {
          ...
          this.alertService.showStickyMessage('Save Error',
            `An error occurred whilst saving configuration.\r\nError: "${Utilities.getHttpResponseMessage(error)}"`,
            MessageSeverity.error, error);
        }
      });
  }
